      ...
      <div className="container-fluid   ">
        ...
        <div className="container  ">
          <section className="why-content">
            <h3 className="fs-2 fw-bold ">Why Choose Us</h3>
          </section>
        </div>
        <div className="container-fluid main-form-style ">
          <div class="col-xl-4">
            <div class="p-3 border ">
              <div class="address mb-3 border-bottom">
                <h5 class="mb-0 fw-bold ">Address</h5>
                <p class="mb-3 font-12 ">123 Street Name, City, Australia</p>
              </div>

              <div class="phone mb-3 border-bottom">
                <h5 class="mb-0 fw-bold">Phone</h5>
                <p class="mb-0 font-13">Toll Free (123) 472-796</p>
                <p class="mb-3 font-13">Mobile : +91-9910XXXX</p>
              </div>

              <div class="email mb-3 border-bottom">
                <h5 class="mb-0 fw-bold">Email</h5>
                <p class="mb-3 font-13">mail@example.com</p>
              </div>

              <div class="working-days mb-0">
                <h5 class="mb-0 fw-bold">Working Days</h5>
                <p class="mb-3 font-13">Mon - FRI / 9:30 AM - 6:30 PM</p>
              </div>
            </div>
          </div>
